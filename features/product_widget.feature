Feature: Test scenarios for Product widget

  @cart
  Scenario: Add product to cart from product widget
    Given a user visits home page "http://automationpractice.com"
    When click on Add to cart button on widget with product name "Faded Short Sleeve T-shirts"
